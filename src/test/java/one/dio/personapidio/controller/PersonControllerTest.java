...
import static one.dio.personapidio.utils.PersonUtils.asJsonString;
import static one.dio.personapidio.utils.PersonUtils.createFakeDTO;
...
public class PersonControllerTest {
    ...
    @Test
    void testWhenGETWithValidIsCalledThenAPersonShouldBeReturned() throws Exception, PersonNotFoundException {
    ...
    @Test
    void testWhenGETWithInvalidIsCalledThenAnErrorMessagenShouldBeReturned() throws Exception, PersonNotFoundException {
        var expectedValidId = 1L;
        PersonDTO expectedPersonDTO = createFakeDTO();
        expectedPersonDTO.setId(expectedValidId);
    ...
    @Test
    void testWhenPUTIsCalledThenAPersonShouldBeUpdated() throws Exception, PersonNotFoundException {
        var expectedValidId = 1L;
        PersonDTO expectedPersonDTO = createFakeDTO();
